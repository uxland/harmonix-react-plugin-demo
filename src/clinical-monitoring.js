 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const l = globalThis, u = l.ShadowRoot && (l.ShadyCSS === void 0 || l.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, S = Symbol(), m = /* @__PURE__ */ new WeakMap();
let M = class {
  constructor(e, t, i) {
...
const A = (s) => new M(typeof s == "string" ? s : s + "", void 0, S), C = (s, e) => {
...
}, f = u ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: O, defineProperty: R, getOwnPropertyDescriptor: z, getOwnPropertyNames: I, getOwnPropertySymbols: k, getPrototypeOf: T } = Object, d = globalThis, y = d.trustedTypes, L = y ? y.emptyScript : "", V = d.reactiveElementPolyfillSupport, h = (s, e) => s, p = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? L : null;
      break;
...
class a extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    ...
    return { get() {
      ...
      const E = r?.call(this);
      o.call(this, n), this.requestUpdate(e, E, i);
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of i) t.unshift(f(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && i.reflect === !0) {
      const o = (i.converter?.toAttribute !== void 0 ? i.converter : p).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const o = i.getPropertyOptions(r), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : p;
      this._$Em = r, this[r] = n.fromAttribute(t, o.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, i) {
    if (e !== void 0) {
...
a.elementStyles = [], a.shadowRootOptions = { mode: "open" }, a[h("elementProperties")] = /* @__PURE__ */ new Map(), a[h("finalized")] = /* @__PURE__ */ new Map(), V?.({ ReactiveElement: a }), (d.reactiveElementVersions ??= []).push("2.0.4");
const j = ":host{min-height:1px;height:100%;width:100%;max-width:100%;display:block}primaria-region>div{display:contents}.wrapper{position:relative;min-height:1px;height:100%;width:100%;max-width:100%;display:flex;flex-direction:row}.wrapper #widgets-sidebar-region{width:25%;max-width:25%;min-width:0;flex-shrink:0;overflow:auto}.wrapper .content{flex:1;min-width:0;display:flex;flex-direction:column}.wrapper .content #header-widgets-region{display:grid;grid-template-columns:repeat(3,1fr);gap:24px;padding:24px 12px 0 24px}.wrapper .content #content-widgets-region{flex:1;min-height:1px;height:100%;padding:24px 12px 24px 24px}@media (max-width: 1439px){:host{min-height:100vh}.wrapper{flex-direction:column}.wrapper #widgets-sidebar-region{max-width:100%;width:auto;overflow:auto;min-height:100%}.wrapper .content #content-widgets-region{height:70vh;flex:none}}", q = (s) => $`
    <div class="wrapper">
      <div class="content">
...
let c = g;
const N = async (s) => {
  U("clinical-monitoring")(c), s.regionManager.registerMainView({
